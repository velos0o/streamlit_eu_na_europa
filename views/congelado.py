...
def render_congelado_content(df_congelados: pd.DataFrame):
    ...
    try:
        ...
        st.warning(f"Falha ao montar STATUS CONGELADOS: {e}")
...
def show_congelado(title: str = "Congelado"):
    """Exibe a página completa de Congelados."""
    ...
    if df_congelados is None or df_congelados.empty:
        st.info("Nenhum registro congelado encontrado.")
        return
